...
public class MultiVideoDemo : MonoBehaviour 
{
	...
	void Start()
	{
		...
		string folder = "Assets/AVProWindowsMedia/Demos/Shared/";
		Add(folder, "blue-480x256-divx.avi");
		Add(folder, "green-480x256-divx.avi");
		Add(folder, "purple-480x256-divx.avi");
		Add(folder, "yellow-480x256-divx.avi");
	}
