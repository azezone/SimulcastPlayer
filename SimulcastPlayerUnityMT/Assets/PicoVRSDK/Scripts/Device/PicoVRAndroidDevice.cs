...
#region Properties
    ...
    private string UnityVersion = "0.4.1.0";
...
#region PicoPlugin
    ...
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
    private static extern bool PVR_GetUsePredictedMatrix();
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
    private static extern float PVR_GetBatteryLevel();
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
    private static extern void PVR_SetPupillaryPoint(bool enable);
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
    private static extern bool PVR_GetSensorState(
        bool monoscopic,
        ref float w,
        ref float x,
        ref float y,
    ...
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
    private static extern bool PVR_GetAsyncFlag();
    [DllImport(LibFileName, CallingConvention = CallingConvention.Cdecl)]
